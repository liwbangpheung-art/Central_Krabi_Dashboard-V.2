-- Central Krabi Dashboard v2.9.0-c7-preview
-- Supabase full database setup
-- ใช้รันใน Supabase SQL Editor ไฟล์เดียว
-- ลำดับ: migrations 001-018
-- หมายเหตุ: ควร Backup ก่อนรันใน Production
...
-- Verification helper
select
  'central_krabi_dashboard_v2_9_0_c7_preview_setup_complete' as status,
  now() as completed_at;
