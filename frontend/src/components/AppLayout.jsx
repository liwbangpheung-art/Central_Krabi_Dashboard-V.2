...
const dashboardNavItem = { to: "/", label: "แดชบอร์ดภาพรวม", icon: "chart", end: true };
...
const navigationGroups = [
  {
    ...
    defaultOpen: true,
    items: [
      { to: "/entry/tissue", label: "กระดาษทิชชู่ (รายเดือน)", icon: "document" },
      { to: "/entry/garbage-bag", label: "ถุงดำ/ถุงขยะ (รายเดือน)", icon: "box" },
      { to: "/entry/rdf", label: "ขยะ RDF (รายวัน)", icon: "currency" },
      { to: "/entry/dog-food", label: "อาหารหมา (รายวัน)", icon: "layers" },
      { to: "/entry/wet-waste", label: "ขยะเปียก & อาหารหมู", icon: "layers" },
      { to: "/entry/recycle", label: "ขยะรีไซเคิล (รายเดือน)", icon: "recycle" }
    ]
  },
  {
    id: "reports",
    ...
    defaultOpen: false,
    items: [
      { to: "/analytics", label: "วิเคราะห์และกราฟ", icon: "trend" },
      { to: "/export", label: "สร้างรายงาน PowerPoint", icon: "download" },
      { to: "/data-quality", label: "ตรวจคุณภาพข้อมูล", icon: "check" }
    ]
  },
  {
    id: "system",
    ...
    defaultOpen: false,
    items: [
      { to: "/master-data", label: "จัดการประเภทข้อมูล", icon: "folder" },
      { to: "/users", label: "จัดการผู้ใช้", icon: "users", permission: "manage_users" }
    ]
  }
];
