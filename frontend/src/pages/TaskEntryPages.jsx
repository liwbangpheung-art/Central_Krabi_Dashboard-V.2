...
export function MonthlyCategoryEntryPage({
  ...
  return (
    <>
      <section className="page-heading task-entry-heading">
        <div>
      ...
      <section className="task-entry-card">
        <div className="task-entry-toolbar">
          <label>ปี/เดือน พ.ศ.
          ...
          <div className="task-table-actions">
            <label className="secondary-button task-upload-button">นำเข้า CSV<input type="file" accept=".csv,text/csv" hidden onChange={importCurrentCsv} disabled={state.saving || state.loading} /></label>
      ...
      <section className="task-entry-card">
        <div className="task-table-heading">
          ...
          <div className="task-table-actions">
            ...
            <label className="secondary-button task-upload-button">นำเข้า CSV<input type="file" accept=".csv,text/csv" hidden onChange={importRecycleCsv} disabled={state.saving} /></label>
...
export function WetWastePorkPage() {
  ...
  return (
    <>
      ...
      <section className="task-entry-card">
        <div className="task-table-heading">
          ...
          <div className="task-table-actions">
            ...
            <label className="secondary-button task-upload-button">นำเข้า CSV<input type="file" accept=".csv,text/csv" hidden onChange={importPigCsv} disabled={state.saving} /></label>
      ...
      {pigModalOpen && (
        <div className="task-modal-backdrop" role="dialog" aria-modal="true">
          <div className="task-modal small-task-modal">
