...
export function DailyEntryPage() {
  ...
  function confirmDiscard() {
    return !dirty || window.confirm("มีข้อมูลที่ยังไม่ได้บันทึก ต้องการละทิ้งการเปลี่ยนแปลงหรือไม่?");
  }
    ...
    <>
      <section className="page-heading daily-page-heading">
        <div>
          ...
          <p>เลือกหมวด ประเภท และเดือน จากนั้นกรอกข้อมูลครบทั้งเดือนในหน้าเดียว ระบบจะรวมรายสัปดาห์และรายเดือนให้อัตโนมัติ</p>
        </div>
