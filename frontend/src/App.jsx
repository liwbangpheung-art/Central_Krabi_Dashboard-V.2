      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedApp config={config} />}>
            ...
            <Route path="entry/rdf" element={<DailyEntryPage initialModule="waste" fixedModule headingTitle="ขยะ RDF (รายวัน)" headingDescription="กรอกปริมาณขยะ RDF รายวัน หน่วยกิโลกรัม สามารถใช้ทศนิยมได้" />} />
            <Route path="entry/dog-food" element={<DailyEntryPage initialModule="animal_feed" fixedModule headingTitle="อาหารหมา (รายวัน)" headingDescription="กรอกปริมาณอาหารหมารายวัน หน่วยกิโลกรัม สามารถใช้ทศนิยมได้" />} />
