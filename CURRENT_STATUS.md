# Current Status — v2.9.0-c7-preview

สถานะปัจจุบัน: **Phase C7 Advanced Report Wizard / Preview**

รอบนี้ยกระดับจาก C6 Preview ให้เป็น Advanced Wizard จริงขึ้น โดยเพิ่ม editable slide outline, per-slide layout, smart readability warning, theme และ mini slide preview

## ทำแล้วใน C7

- Bump version เป็น `2.9.0-c7-preview`
- เพิ่ม Theme System:
  - Executive Dark
  - Clean Government
  - Eco Green
  - Minimal White
- เพิ่ม Editable Slide Outline:
  - เปลี่ยนชื่อสไลด์
  - เลือก layout ต่อสไลด์
  - เปิด/ปิดสไลด์ที่ไม่ locked
  - ขยับลำดับขึ้น/ลง
- เพิ่ม Per-slide Layout Selection:
  - Auto
  - KPI + Chart + Analysis
  - Chart Focus
  - Table Focus
  - Analysis Focus
  - Data Quality Focus
- เพิ่ม Smart Readability Engine:
  - warning เมื่อ table เยอะและต้อง split
  - warning เมื่อ category เยอะและต้อง Top 7
  - warning เมื่อ bullet ยาวและต้อง truncate
- เพิ่ม Mini Slide Preview ใน outline
- ปรับ Preset ให้เก็บ config ใหม่ เช่น theme และ slideOutlineOverrides ได้

## สถานะ

เหมาะสำหรับ **Internal Review / Advanced Preview**
ยังควรเพิ่ม unit test และ live UAT ก่อน Production release เต็ม
...
# Current Status — v2.8.0-c6-preview

สถานะปัจจุบัน: **Phase C6 Preview / Internal Review**

เวอร์ชันนี้ไม่ใช่ Production release เต็ม เป็น preview เพื่อทดสอบ Report Builder, PowerPoint readability และ Enterprise report flow ก่อนเข้า UAT จริง

## ทำแล้วในชุดนี้

- ปรับ version เป็น `2.8.0-c6-preview`
- เพิ่ม Report Builder Wizard ขั้นต่ำในหน้า Export
- เพิ่ม Preview Slide Outline ก่อนสร้างไฟล์
- เพิ่ม Readability Rules:
  - ตารางมากกว่า 8 แถว แยกเป็นหลายสไลด์
  - Breakdown แสดง Top 7
  - Bullet ยาวเกินตัดให้สั้น
  - หัวข้อสไลด์ยาวเกินตัดให้พอดี
- เพิ่ม loading state ของ Preview
- ปรับฟอนต์ PowerPoint และ Preview ให้ใหญ่ขึ้น

## สถานะคะแนน

- Phase B Data Governance: 95/100
- Repository structure: 90/100
- Testing: 82/100
- Phase C6 Report Builder Preview: 78/100
- PowerPoint Readability: 78/100
- Version consistency: 85/100

คะแนนรวมประมาณ: **86/100**

## ยังไม่ควรเรียกว่า Production

ยังควรทำต่อก่อน UAT จริง:

- เพิ่ม unit test สำหรับ report-builder/report-generator
- เพิ่มตัวอย่าง PowerPoint ดี/แย่ใน docs
- ทำ Live E2E กับ Supabase จริง
- ตรวจ backend generator ให้ใช้ layout rules เท่ากับ frontend ครบทุก section
